...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result && $result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            // Only allow dashboard if approved
    ...
    // Try to find user in 'nurses' table
    ...
    header('Location: /Web-Based%20Health-Integrated%20Student%20Information%20System/templates/register/login.php?error=Invalid+email+or+password');
    exit();
} else {
